...
const PastPortfolioManagement = () => {
  ...
  const fetchPortfolio = async () => {
    try {
      const response = await axios.get("http://localhost:3005/gallery2/getall");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isUpdateMode) {
        await axios.put(
          `http://localhost:3005/gallery2/updateImage/${selectedId}`,
          formPayload,
          {
            headers: {
        ...
        await axios.post(
          "http://localhost:3005/gallery2/createGallery",
          formPayload,
          {
            headers: {
              "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(
        `http://localhost:3005/gallery2/deleteImage/${selectedId}`
      );
  ...
  return (
    <>
      <div className="font-bold text-3xl mb-8 ">Gallery Management</div>
